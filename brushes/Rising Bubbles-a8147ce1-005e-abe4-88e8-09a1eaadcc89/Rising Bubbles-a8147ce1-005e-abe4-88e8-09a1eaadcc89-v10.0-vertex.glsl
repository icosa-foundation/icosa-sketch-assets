...
// Rising Bubbles vertex shader - copied from Stars pattern
...
void main() {
  // Use the working particle positioning but with a_normal as center
  vec4 pos = PositionParticle(float(gl_VertexID), a_position, a_normal, 0.0);
